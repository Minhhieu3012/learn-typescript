...
const submitModalUpdate = () => {
  ...
  if (btnUpdate) {
    btnUpdate.addEventListener("click", async () => {
      ...
      const newDeleteBtn = document.querySelector(`.delete-post[data-delete-id="${res.id}"]`) as HTMLButtonElement;
      const newEditBtn = document.querySelector(`.edit-post[data-update-id="${res.id}"]`) as HTMLButtonElement;

...
const actionEdit = (btnElement: HTMLButtonElement) => {
  btnElement.addEventListener("click", () => {
    ...
    (document.getElementById("titleUpdate") as HTMLInputElement).value = title || "";
    (document.getElementById("authorUpdate") as HTMLInputElement).value = author || "";
    (document.getElementById("contentUpdate") as HTMLInputElement).value = content || "";
...
const handleBindEditButtons = () => {
  ...
  editBtns.forEach((btn, index) => {
    actionEdit(btn as HTMLButtonElement);
  });
};
...
const handleUpdateBlog = () => {
  ...
  if (btnUpdate) {
    btnUpdate.addEventListener("click", async () => {
      ...
      const titleInput = document.getElementById("titleUpdate") as HTMLInputElement;
      const authorInput = document.getElementById("authorUpdate") as HTMLInputElement;
      const contentInput = document.getElementById("contentUpdate") as HTMLInputElement;
      ...
      const newDeleteBtn = document.querySelector(`.delete-blog[data-id="${res.id}"]`) as HTMLButtonElement;
      const newEditBtn = document.querySelector(`.edit-blog[data-update-id="${res.id}"]`) as HTMLButtonElement;
